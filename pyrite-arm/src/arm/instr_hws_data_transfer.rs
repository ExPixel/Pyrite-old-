...
fn strh(cpu: &mut ArmCpu, memory: &mut dyn ArmMemory, rd: u32, addr: u32) {
...
arm_gen_hwsdt!(arm_ldrh_ofim, ldrh, LOAD, 16, off_imm, DEC, PRE, NO_WRITEBACK);

// Load halfword, Positive immediate offset
arm_gen_hwsdt!(arm_ldrh_ofip, ldrh, LOAD, 16, off_imm, INC, PRE, NO_WRITEBACK);

// Load halfword, Negative register offset
arm_gen_hwsdt!(arm_ldrh_ofrm, ldrh, LOAD, 16, off_reg, DEC, PRE, NO_WRITEBACK);

// Load halfword, Positive register offset
arm_gen_hwsdt!(arm_ldrh_ofrp, ldrh, LOAD, 16, off_reg, INC, PRE, NO_WRITEBACK);
...
arm_gen_hwsdt!(arm_ldrsb_ofim, ldrsb, LOAD, 8, off_imm, DEC, PRE, NO_WRITEBACK);

// Load signed byte, Positive immediate offset
arm_gen_hwsdt!(arm_ldrsb_ofip, ldrsb, LOAD, 8, off_imm, INC, PRE, NO_WRITEBACK);

// Load signed byte, Negative register offset
arm_gen_hwsdt!(arm_ldrsb_ofrm, ldrsb, LOAD, 8, off_reg, DEC, PRE, NO_WRITEBACK);

// Load signed byte, Positive register offset
arm_gen_hwsdt!(arm_ldrsb_ofrp, ldrsb, LOAD, 8, off_reg, INC, PRE, NO_WRITEBACK);
...
arm_gen_hwsdt!(arm_ldrsb_ptim, ldrsb, LOAD, 8, off_imm, DEC, POST, WRITEBACK);

// Load signed byte, Immediate offset, post-increment
arm_gen_hwsdt!(arm_ldrsb_ptip, ldrsb, LOAD, 8, off_imm, INC, POST, WRITEBACK);

// Load signed byte, Register offset, post-decrement
arm_gen_hwsdt!(arm_ldrsb_ptrm, ldrsb, LOAD, 8, off_reg, DEC, POST, WRITEBACK);

// Load signed byte, Register offset, post-increment
arm_gen_hwsdt!(arm_ldrsb_ptrp, ldrsb, LOAD, 8, off_reg, INC, POST, WRITEBACK);

// Load signed halfword, Negative immediate offset
arm_gen_hwsdt!(arm_ldrsh_ofim, ldrsh, LOAD, 16, off_imm, DEC, PRE, NO_WRITEBACK);

// Load signed halfword, Positive immediate offset
arm_gen_hwsdt!(arm_ldrsh_ofip, ldrsh, LOAD, 16, off_imm, INC, PRE, NO_WRITEBACK);

// Load signed halfword, Negative register offset
arm_gen_hwsdt!(arm_ldrsh_ofrm, ldrsh, LOAD, 16, off_reg, DEC, PRE, NO_WRITEBACK);

// Load signed halfword, Positive register offset
arm_gen_hwsdt!(arm_ldrsh_ofrp, ldrsh, LOAD, 16, off_reg, INC, PRE, NO_WRITEBACK);

// Load signed halfword, Immediate offset, pre-decrement
arm_gen_hwsdt!(arm_ldrsh_prim, ldrsh, LOAD, 16, off_imm, DEC, PRE, WRITEBACK);

// Load signed halfword, Immediate offset, pre-increment
arm_gen_hwsdt!(arm_ldrsh_prip, ldrsh, LOAD, 16, off_imm, INC, PRE, WRITEBACK);

// Load signed halfword, Register offset, pre-decrement
arm_gen_hwsdt!(arm_ldrsh_prrm, ldrsh, LOAD, 16, off_reg, DEC, PRE, WRITEBACK);

// Load signed halfword, Register offset, pre-increment
arm_gen_hwsdt!(arm_ldrsh_prrp, ldrsh, LOAD, 16, off_reg, INC, PRE, WRITEBACK);

// Load signed halfword, Immediate offset, post-decrement
arm_gen_hwsdt!(arm_ldrsh_ptim, ldrsh, LOAD, 16, off_imm, DEC, POST, WRITEBACK);

// Load signed halfword, Immediate offset, post-increment
arm_gen_hwsdt!(arm_ldrsh_ptip, ldrsh, LOAD, 16, off_imm, INC, POST, WRITEBACK);

// Load signed halfword, Register offset, post-decrement
arm_gen_hwsdt!(arm_ldrsh_ptrm, ldrsh, LOAD, 16, off_reg, DEC, POST, WRITEBACK);

// Load signed halfword, Register offset, post-increment
arm_gen_hwsdt!(arm_ldrsh_ptrp, ldrsh, LOAD, 16, off_reg, INC, POST, WRITEBACK);

// Store halfword, Negative immediate offset
arm_gen_hwsdt!(arm_strh_ofim, strh, STORE, 16, off_imm, DEC, PRE, NO_WRITEBACK);

// Store halfword, Positive immediate offset
arm_gen_hwsdt!(arm_strh_ofip, strh, STORE, 16, off_imm, INC, PRE, NO_WRITEBACK);

// Store halfword, Negative register offset
arm_gen_hwsdt!(arm_strh_ofrm, strh, STORE, 16, off_reg, DEC, PRE, NO_WRITEBACK);

// Store halfword, Positive register offset
arm_gen_hwsdt!(arm_strh_ofrp, strh, STORE, 16, off_reg, INC, PRE, NO_WRITEBACK);
...
arm_gen_hwsdt!(arm_strh_ptim, strh, STORE, 16, off_imm, DEC, POST, WRITEBACK);

// Store halfword, Immediate offset, post-increment
arm_gen_hwsdt!(arm_strh_ptip, strh, STORE, 16, off_imm, INC, POST, WRITEBACK);

// Store halfword, Register offset, post-decrement
arm_gen_hwsdt!(arm_strh_ptrm, strh, STORE, 16, off_reg, DEC, POST, WRITEBACK);

// Store halfword, Register offset, post-increment
arm_gen_hwsdt!(arm_strh_ptrp, strh, STORE, 16, off_reg, INC, POST, WRITEBACK);
